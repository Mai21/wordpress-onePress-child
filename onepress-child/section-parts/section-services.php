...
if ( onepress_is_selective_refresh() ) {
    ...
    $layout = 6; //intval( get_theme_mod( 'onepress_service_layout', 6 ) );
                ...
                <div class="row px-5">
                    ...
                    if ( ! empty( $page_ids ) ) {
                        ...
                        foreach ($page_ids as $settings) {
                            ...
                            <div class="col-12 col-sm-6 alignwide top-service">
                                <div class="service-frame bg-white p-5 m-3">
                                    ...
                                    <div class="wp-block-media-text__content">
                                        <p class="has-large-font-size"><?php echo get_the_title( $post ); ?></p>
